...
const API_URL = "https://trustbridgeb2b.com/backend/wp-json/trustbridge/v1/items";
...
export default async function HomePage({ 
  ...
  // 1. Extragem limba și dicționarul
      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-6 py-8 lg:grid-cols-[280px_1fr]">
        ...
        <div className="space-y-6">
          ...
          <div className="flex overflow-hidden rounded-2xl border bg-white shadow-sm">
            ...
            <Link
              href={`/${lang}/marketplace`}
              className="bg-orange-400 px-7 py-4 text-sm font-black uppercase text-white transition hover:bg-orange-500 flex items-center"
            >
          ...
          <div className="rounded-2xl border bg-white p-5 shadow-sm">
            <div className="flex items-center justify-between gap-4 border-b pb-4">
              ...
              <Link
                href={`/${lang}/marketplace`}
                className="hidden rounded-xl bg-slate-950 px-5 py-3 text-xs font-black uppercase text-white md:block hover:bg-slate-800"
              >
                {dict.home.view_all}
              </Link>
            </div>
            ...
            <div className="mt-6 grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
              {featuredItems.length > 0 ? (
                featuredItems.map((item: any) => (
                  <div key={item.id} className="group overflow-hidden rounded-2xl border bg-white transition hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <div className="p-5">
                      ...
                      {/* AFISARE PRET NUMERIC + VALUTA SAU STATUS */}
    ...
    item.price_status === "request"
      ...
      : item.price_status || dict.common.price_on_request
                ...
                <div className="col-span-full py-12 text-center text-slate-400">
                  {dict.marketplace.loading || "Încărcăm ofertele..."}
                </div>
              )}
            </div>
